          ...
          defs.value = 
            `
              <linearGradient id="paint6_linear" ${-9.3410 + props.x} ${-47.1180 + props.y} ${-8.7470 + props.x} ${-8.3150 + props.y} gradientUnits="userSpaceOnUse">
                ...
                <linearGradient id="paint9_linear" ${-9.7060 + props.x} ${-40.7300 + props.y} ${-10.4830 + props.x} ${-12.8500 + props.y} gradientUnits="userSpaceOnUse">
                <stop stop-color="white" stop-opacity="0"/>
